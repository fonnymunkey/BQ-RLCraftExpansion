...
public class ClearMultiblockCacheCommand extends CommandBase{
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] params) throws CommandException {
		...
		String message = TaskMultiblock.clearHashmap();
	...
	public String getName() {
		return "clearMultiblockCache";
	}
	
	@Override
	public String getUsage(ICommandSender sender) {
		return "command.clearMultiblockCache.usage";
	}
}
